...
You can download a demo app showcasing the SDK's functionality [here](https://github.com/dataspike-io/Deepfake-MobileSDK-Android/releases/download/v1.0.0/deepfake-demo-app-1.0.0.apk).
...
You can browse the [sample directory](./io/dataspike/deepfake-sdk/sample) to see a practical, focused example of how to use the SDK in your own application.
